...
本项目每周四自动为 [**V2Ray**](https://github.com/v2fly/v2ray-core) 生成 `geoip.dat` 规则文件，兼容 [Trojan-Go](https://github.com/p4gefau1t/trojan-go)。

## 与官方版 geoip.dat 不同之处

- 中国大陆 IPv4 地址数据使用 [IPIP.net](https://github.com/17mon/china_ip_list/blob/master/china_ip_list.txt)
- 新增了 `geoip:telegram` 类别，方便习惯于黑名单模式的用户使用
